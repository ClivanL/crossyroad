...
//     if (checkCollision(app.gameState[carPos[i][0]][carPos[i][1]+1])!=="crash"){
//   if(carPos[i][1]===app.gameState[carPos[i][0]].length-1){
//     app.gameState[carPos[i][0]][carPos[i][1]]="R";
//     carPos[i][1]=0;
//   }
//   else {

//     app.gameState[carPos[i][0]][carPos[i][1]]="R";
//     app.gameState[carPos[i][0]][carPos[i][1]+1]="C";
//     carPos[i][1]=carPos[i][1]+1;
//     createMap();
//   }
//   }
// }
